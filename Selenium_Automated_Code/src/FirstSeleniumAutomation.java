import Services.MainFrameMenus.MainMenu;
import Services.WebApp.WebAppService;
import Objects.WebApp.*;
...
public class FirstSeleniumAutomation {
    ...
    public static void main(String[] args) throws ParseException, InterruptedException, IOException, JSONException, org.json.simple.parser.ParseException {
