...
public class UPDATESpecificPlan {
    ...
    private coveredPropertyTypesJSON[] covered_property_types;
    private planJSON[] options;
    private planJSON[] plans;
    private updatePriceTierJSON[] pricing_tiers;
    private serviceMapsJSON[] service_maps;
